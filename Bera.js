...
module.exports = Bera = async (client, m, chatUpdate, message, store) => {
  try {
    ...
    const context = {
      ...
      participants, pushname, body, budy, totalCommands, args, mime, qmsg, msgBera, botNumber, itsMe, packname,
